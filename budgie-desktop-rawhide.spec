...
git reset --hard 96ea41416016b82ebb847ef44ad97f42e4a3a76f
git submodule update --init
curl -s https://patch-diff.githubusercontent.com/raw/BuddiesOfBudgie/budgie-desktop/pull/54.patch | git apply -v -
